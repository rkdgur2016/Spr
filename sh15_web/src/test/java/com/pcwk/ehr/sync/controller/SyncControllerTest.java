...
public class SyncControllerTest implements PLog{
	...
	public void setUp() throws Exception {
		log.debug("┌──────────────────────────────────────────┐");
		log.debug("│ SyncControllerTest : setUp()             │");
		log.debug("└──────────────────────────────────────────┘");
	...
	public void syncResult() throws Exception	{
		...
		//1. url호출, param set
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/sync/sync_result.do")
				.param("name", "홍길동");
	...
	public void handlerSyncIndex() throws Exception {
		...
		//MockMvcRequestBuilders.[get] -> 통신 방식 ex} post or get
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/sync/sync_index.do");
