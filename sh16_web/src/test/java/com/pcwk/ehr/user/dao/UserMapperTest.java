...
public class UserMapperTest implements PLog {
	...
	public void setUp() throws Exception {
		...
		userVO01 = new User("rogan01", "이상무01", "4321", "2002/12/31", Level.BASIC, 1, 0, "ddswlstj@naver.com",
				"sysdate사용");
		userVO02 = new User("rogan02", "이상무02", "4321", "2002/12/30", Level.SILVER, 50, 2, "ddswlstj@naver.com",
				"sysdate사용");
		userVO03 = new User("rogan03", "이상무03", "4321", "2002/12/29", Level.GOLD, 100, 31, "ddswlstj@naver.com",
				"sysdate사용");
	...
	public void doUpdate() throws SQLException {
		...
		User upoutVO = userMapper.doSelectOne(userVO01);
