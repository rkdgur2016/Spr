		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item">
						<a class="nav-link active" aria-current="page" href="${CP}/user/doRetrieve.do">Member</a>
					</li>
					<li class="nav-item">
						<a class="nav-link active" aria-current="page" href="${CP}/board/doDelete.do">Board</a>
					</li>
					<li class="nav-item">
						<a class="nav-link active" aria-current="page" href="${CP }/template/list.do">template list</a>
					</li>
					<li class="nav-item">
						<a class="nav-link active" aria-current="page" href="${CP }/template/reg.do">template reg</a>
					</li>
				</ul>
				<ul class="navbar-nav">
					<li class="nav-item">
